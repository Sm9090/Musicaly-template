...
import music_industry_news_data from '@/data/music-industry-news-data';
                    ...
                    <div className="row align-items-end mb-25 bdFadeUp">
                        <div className="col-lg-6">
                            <div className="section__title-wrapper mb-40 bd-title-anim">
                                <span className="section__subtitle">Industry Updates</span>
                                <h2 className="section__title">Music Industry <span className="animated-underline active">
                                    News & Insights</span>
                                </h2>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="ms-news-btn d-flex justify-content-lg-end mb-40">
                                <Link className="border__btn" href="#">View All News</Link>
                            </div>
                        </div>
                    </div>
                    <div className="row bdFadeUp">
                        {
                            music_industry_news_data.slice(0, 3).map((item) => (
                                <div className="col-xl-4 col-md-6" key={item.id}>
                                    <div className="ms-news-item p-relative zindex-1 mb-40">
                                        <div className="ms-news-overlay p-absolute"></div>
                                        <Link className="ms-news4-cat" href="#">{item.category}</Link>
                                        ...
                                        <div className="ms-news-content ms-news-position p-absolute">
                                            <h3 className="ms-news-title mb-15"><Link href="#">{item.title}</Link></h3>
