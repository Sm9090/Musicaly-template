                ...
                <div className="row align-items-end mb-25 bdFadeUp">
                    <div className="col-lg-8">
                        <div className="section__title-wrapper mb-40 bd-title-anim">
                            <span className="section__subtitle">Featured Streams</span>
                            <div id="msg-title">
                                <h2 className="section__title"><span className="animated-underline active">Music & Video</span> {" "}
                                     Highlights</h2>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="trending-btn mb-40 d-flex justify-content-lg-end">
                            <Link className="border__btn" href="#">View All</Link>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="trending-item" key={item.id}>
                                        ...
                                        <div className="trending__info">
                                            ...
                                            <div className="trending__content">
                                                <h4><Link href={`#`}>{item.subTitle}</Link></h4>
