                    ...
                    <div className="row align-items-end mb-25 bdFadeUp">
                        <div className="col-xl-6 col-lg-6">
                            <div className="section__title-wrapper mb-40 bd-title-anim">
                                <span className="section__subtitle">Artists</span>
                                <h2 className="section__title msg_title">
                                    <span className="animated-underline active">Featured Artists</span> {" "}
                                     Directory
                                </h2>
                            </div>
                        </div>
                                                                ...
                                                                <div className="ms-popular__thumb">
                                                                    ...
                                                                    <Link href={`#`}>
                                                                        <Image loader={imageLoader} placeholder="blur" loading='lazy' style={{ width: '100%', height: "auto" }} src={item.image}
                                                                            alt="featured artist" /></Link>
                                                                    <Link href={`#`} className="ms-popular__link">
                                                                        <span className="ms-popular-icon"><i
                                                                            className="fa-regular fa-arrow-right-long"></i></span>
                                                                    </Link>
                                                                </div>
                                                                <h4 className="ms-popular__title"><Link href={`#`}>
                                                                    {item.title}
                                                                </Link></h4>
                                                            </div>
                                                        </SwiperSlide>
                                                        ...
                                                        <SwiperSlide key={item.id}>
                                                            <div className="ms-popular__item p-relative mb-30">
                                                                <div className="ms-popular__thumb">
                                                                    <div className="ms-popular-overlay"></div>
                                                                    <Link href={`#`}>
                                                                        <Image loader={imageLoader} placeholder="blur" loading='lazy' style={{ width: '100%', height: "auto" }} src={item.image} alt="featured artist" />
                                                                    </Link>
                                                                    <Link href={`#`} className="ms-popular__link">
                                                                        <span className="ms-popular-icon"><i
                                                                            className="fa-regular fa-arrow-right-long"></i></span>
                                                                ...
                                                                <h4 className="ms-popular__title"><Link href={`#`}>{item.title}</Link>
                                                                </h4>
                                                            </div>
                                                        </SwiperSlide>
                                                    ))
                                                        ...
                                                        <SwiperSlide key={item.id}>
                                                            <div className="ms-popular__item p-relative mb-30">
                                                                <div className="ms-popular__thumb">
                                                                    <div className="ms-popular-overlay"></div>
                                                                    <Link href={`#`}>
                                                                        <Image loader={imageLoader} placeholder="blur" loading='lazy' style={{ width: '100%', height: "auto" }} src={item.image} alt="featured artist" /></Link>
                                                                    <Link href={`#`} className="ms-popular__link">
                                                                        <span className="ms-popular-icon"><i
                                                                            className="fa-regular fa-arrow-right-long"></i></span>
                                                                    </Link>
                                                                </div>
                                                                <h4 className="ms-popular__title"><Link href={`#`}>{item.title}
                                                                </Link></h4>
                                                            </div>
                                                        </SwiperSlide>
                                                    ))
